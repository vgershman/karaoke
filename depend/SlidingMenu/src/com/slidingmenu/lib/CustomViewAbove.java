...
public class CustomViewAbove extends ViewGroup {
    ...
    public void moveOver(){
        int sx = getScrollX();
        int right = ((Activity) getContext()).getWindowManager().getDefaultDisplay().getWidth();
        mScroller.startScroll(sx, 0, -right - sx, 0, 200);
        invalidate();
    }
    public void moveOverLeft(){
        int sx = getScrollX();
        mScroller.startScroll(sx, 0,  sx, 0, 2000);
        invalidate();
    }
